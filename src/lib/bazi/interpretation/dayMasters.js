...
export const DAY_MASTERS = {
  ...
  '丁': {
    ...
    kekuatanDescriptors: ['Insight Mendalam', 'Empati Akurat'],
    bayanganDescriptors: ['Overthinking Akut', 'Sensitif Berlebihan'],
  ...
  '庚': {
    ...
    kekuatanDescriptors: ['Ketegasan Murni', 'Logika Tajam'],
    bayanganDescriptors: ['Kasar Tanpa Sadar', 'Tidak Sabaran'],
  ...
  '辛': {
    ...
    kekuatanDescriptors: ['Selera Tinggi', 'Presisi Estetika'],
    bayanganDescriptors: ['Standar Mustahil', 'Kritis Berlebihan'],
  ...
  '壬': {
    ...
    kekuatanDescriptors: ['Kedalaman Pikiran', 'Intuisi Tajam'],
    bayanganDescriptors: ['Mood Tak Terduga', 'Sulit Dipegang'],
  ...
  '癸': {
    ...
    kekuatanDescriptors: ['Empati Resapan', 'Sensitivitas Akurat'],
    bayanganDescriptors: ['Menyerap Emosi Orang Lain', 'Batas Diri Tipis'],
