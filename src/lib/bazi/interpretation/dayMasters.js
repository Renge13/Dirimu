...
export const DAY_MASTERS = {
  ...
  '庚': {
    ...
    traits: [
      ...
      'Kejujuranmu kadang menyakitkan, tapi membersihkan yang busuk',
  ...
  '壬': {
    ...
    traits: [
      ...
      'Kamu bisa menenangkan badai orang lain sambil menyimpan tsunami sendiri',
      'Kamu bisa berganti bentuk tanpa kehilangan kedalamanmu',
      'Kamu sering ditarik oleh sesuatu yang tidak dilihat orang lain',
      'Kamu pendiam yang menyimpan seluruh semesta di dalam',
      'Kamu tidak bisa dimiliki, tapi orang sering mencarimu',
      'Kamu menyembunyikan harta karun di kedalaman yang tidak sembarang orang selami',
