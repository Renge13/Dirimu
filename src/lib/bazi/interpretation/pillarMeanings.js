...
export const PILLAR_STEM_MEANINGS = {
  year: {
    ...
    '己': 'Dunia melihatmu sebagai sosok yang rendah hati dan peduli, selalu siap membantu tanpa banyak bicara.',
  ...
  day: {
    '甲': 'Inti dirimu adalah keteguhan yang tidak mudah goyah, bahkan saat tidak ada yang menopangmu.',
    '乙': 'Inti dirimu adalah kelenturan yang membuatmu bisa bertahan di segala musim, tanpa kehilangan esensi.',
    '丙': 'Inti dirimu adalah kehangatan yang ingin menerangi dan memberi energi pada sekitar.',
    '丁': 'Inti dirimu adalah kepekaan yang menangkap apa yang orang lain lewatkan, dan tetap setia menjaga nyala kecil itu.',
    '戊': 'Inti dirimu adalah stabilitas yang menjadi fondasi, tempat orang lain merasa aman untuk berlabuh.',
    '己': 'Inti dirimu adalah kesuburan yang ingin menumbuhkan dan merawat, bahkan sering lupa menyirami diri sendiri.',
    '庚': 'Inti dirimu adalah ketajaman dan kejujuran yang tidak suka berbelit, meski kadang menyayat tanpa sengaja.',
    '辛': 'Inti dirimu adalah presisi dan standar tinggi yang membuatmu terus mengasah hingga mencapai yang terbaik.',
    '壬': 'Inti dirimu adalah lautan dalam yang penuh visi dan arus pemikiran, sulit dibatasi definisi sederhana.',
    '癸': 'Inti dirimu adalah kelembutan yang meresap ke mana-mana, bisa merasakan dunia tanpa sekat yang jelas.',
  },
  hour: {
